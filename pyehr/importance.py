        ...
        for fold in folds:
            ...
            for seed in seeds:
                ...
                for feature_weight_item, raw_item in zip(features, test_raw_x):
                    ...
                    selected_features = [item for item in last_feat_dict_sort.items() if abs(item[1]['attention']) > 0.01][:3]
