...
Here is an example of the revised summary report, please follow this format:
...
Here is your initial analysis of the patient, which is not completely reasonable, and you may need to adjust it based on the leader expert's opinion:
{{analysis}}

Here is the opinion of the leader expert:
{{opinion}}

Here is the summary report generated by the leader expert:
{{report}}

You need to consider the leader expert's opinion carefully and provide your opinion on the summary report generated by the leader expert. Please output the following two contents in JSON format:
1. Your viewpoint on the opinion of the leader expert, i.e., the patient's risk is either high or low, respond with "agree" or "disagree".
