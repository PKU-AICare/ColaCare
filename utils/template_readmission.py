...
{"answer":"In my opinion, the patient has a high likelihood of 30-day readmission.", "report": "...", "evidences": ["Doctor 0's ... ", "Doctor 1's ..."]}.
{"answer":"In my opinion, the patient has a low likelihood of 30-day readmission.", "report": "...", "evidences": ["Doctor 0's ... ", "Doctor 1's ..."]}.
...
collaborative_summary_system = """You are an authoritative expert in the medical field. You are organizing a collaborative consultation. Now several doctors have made analysis and judgments on a patient's condition. Your task is to analyze the rationality of each doctor's opinion and summarize the opinions you think are reasonable to obtain a synthesized report for the patient."""
...
1. If a doctor expresses strong opposition to your previous statement, you need to focus on his reasons and arguments and think carefully about whether you need to reconsider the 30-day readmission risk of the patient and modify your synthesized report accordingly.
...
1. Your statement of 30-day readmission risk of the patient.
2. Your revised synthesized report. Please create a concise and clear summary of the patient's health status. Your summary should be informative and beneficial for healthcare prediction tasks, such as the 30-day readmission prediction. Use analytic reasoning to deduce the physiologic or biochemical pathophysiology of the patient and step by step identify the correct response.
...
Here are two examples of the format you should output:
{"answer": "In my opinion, the patient has a high risk of 30-day readmission.", "report": "...", "reasons": ["reason1 ...", "reason2 ..."]}.
{"answer": "In my opinion, the patient has a low risk of 30-day readmission.", "report": "...", "reasons": ["reason1 ...", "reason2 ..."]}.
