...
sc = {
    ...
    "user": Template("""   
        ...
        Then, analyze these three diagnostic reports and give the final probability of death and the corresponding analysis report.
        
        Respond in JSON format as following, without any additional content: {"reason_1": "I think the patient is not likely to survive because...", "reason_2": "I think the patient is likely to survive because...", "reason_3": "I think the patient is likely to ...", "reason":"...", "logits": "..."}
    """)
}
...
debate_collaboration = {
    ...
    "user": Template("""
        In the previous round, you think the death rate of the patient is {{logit}}. And your initial analysis of the patient is {{analysis}}.
        ...
        1. Your revised logits about patient's death rate, respond with a floating-point number between 0 and 1.
        ...
        {"revised_report":"I think the patient is likely to die, because ...","revised_logits": "0.8"}
        {"revised_report":"I think the patient is likely to survive, because ...","revised_logits": "0.1"}
...
specialist_collaboration = {
    ...
    "user": Template("""
        ...
        You need to consider doctors' opinion carefully and output your opinions including the following content in JSON format:
        1. Your revised logits about patient's death rate, respond with a floating-point number between 0 and 1.
        2. Your revised summary report, considering your original statement and other doctors' opinions.

        Here are two examples of the format you should output:
        {"revised_report":"Consider all doctors' opinion, I think the patient is likely to die, because ...","revised_logits": "0.8"}
        {"revised_report":"Consider all doctors' opinion, I think the patient is likely to survive, because ...","revised_logits": "0.1"}
...
confidence_collaboration = {
    ...
    "user": Template("""
        ...
        Here are two examples of the format you should output:
        {"revised_report":"I think the patient is likely to die, because ...","revised_logits": "0.8", "confidence": 0.8}
        {"revised_report":"I think the patient is likely to survive, because ...","revised_logits": "0.1", "confidence": 0.3}
